...
def main():
    ...
    with st.sidebar:
        ...
        <div style='margin-bottom: 20px;'>
            <h3 style='font-size: 1.2em;'>Extraction of PDF data </h3>
        </div>
        """, unsafe_allow_html=True)
        
        st.markdown("""
        <div style='font-size: 0.9em;'>
        Advanced document processing for extracting structured content from PDFs.
        </div>
        """, unsafe_allow_html=True)
        
        st.markdown("---")
        st.markdown("""
        <small style='font-size: 0.8em;'>CrossML Pvt. Ltd. Chandigarh</small>
        """, unsafe_allow_html=True)
